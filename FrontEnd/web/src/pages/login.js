...
import casa from '../assets/cine.jpg';
...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <div className="  h-screen font-sans"><img className="w-screen h-screen absolute " src={casa}></img>
        <div className="absolute container mx-auto h-full flex justify-center items-center">
        <div className="w-1/3">
            <h1 className="font-hairline mb-6 text-center text-2xl">HOLA</h1>
            <div className="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg shadow-lg">
              <form className="px-8 pt-6 pb-8 mb-4 bg-white " onSubmit={ this.loginAccess }>
                <div className="mb-4">
